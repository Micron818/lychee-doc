...
(
	...
	transaction_type varchar(30) NOT NULL,    -- GOODS_RECEIPT,PRODUCTION_RECEIPT,VENDOR_RETURN,DELIVERY,CUSTOMER_RETURN,STOCK_ISSUE,STOCK_RETURN,ADJUSTMENT,STOCK_TRANSFER,BACKFLUSH
...
COMMENT ON COLUMN lychee_erp.stock_transactions.transaction_type
	IS 'GOODS_RECEIPT,PRODUCTION_RECEIPT,VENDOR_RETURN,DELIVERY,CUSTOMER_RETURN,STOCK_ISSUE,STOCK_RETURN,ADJUSTMENT,STOCK_TRANSFER,BACKFLUSH'
;
