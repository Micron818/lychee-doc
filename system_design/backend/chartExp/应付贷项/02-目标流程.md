...
>
> 本文件是已落地的 **V1 未付贷项** 口径。允许贷项超过未付剩余并形成待退款开放金额的下一波设计，见 [供应商退款](../供应商退款/README.md)。
...
- 已付部分不可贷：须先按现网纠错路径作废付款，抬高 `remaining`。这是 V1 限制，不代表真实退款应作废原付款；真实供应商退款见 [供应商退款](../供应商退款/02-目标流程.md)
...
- 未分配贷项（过账后必须核完本单金额）
- 一张贷项核多张 AP
- 已付部分退款 / 供应商退款用途（下一波见 [供应商退款](../供应商退款/README.md)）
- 贷项付款排程
- 成卡后原值调整
- 从采购退货自动生成贷项
