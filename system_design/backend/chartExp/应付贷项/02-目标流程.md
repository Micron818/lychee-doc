...
>
> 本文件是已落地的 **V1 未付贷项** 口径。允许贷项超过未付剩余并形成待退款开放金额的下一波，开发以 [供应商退款-主流程V1](../供应商退款-主流程V1/README.md) 为准；完整目标见 [供应商退款](../供应商退款/README.md)。
...
- 已付部分不可贷：须先按现网纠错路径作废付款，抬高 `remaining`。这是 V1 限制，不代表真实退款应作废原付款；真实供应商退款见 [供应商退款-主流程V1](../供应商退款-主流程V1/02-目标流程.md)
