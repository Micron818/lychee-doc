...
> 当前专题描述已落地的 **V1 未付贷项** 口径。已付 AP 的真实资金退回不应使用付款 VOID 模拟。  
> **下一波开发入口**：[供应商退款-主流程V1](../供应商退款-主流程V1/README.md)（贷项拆分冲原票 / 待退款，并打通现金退款）。  
> 完整目标（换日核销、状态机等）见 [供应商退款](../供应商退款/README.md)，本期不按该范围实施。
